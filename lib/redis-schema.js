...
module.exports = Object.freeze({
    ...
    command: Object.freeze({
        columns: new SchemaEntry({
            key:    'm2m-command:$catalog:columns',
            type:   'hash',
            param:  '$catalog'
        }),
        definitions: new SchemaEntry({
            key:    'm2m-command:$catalog:definitions',
            type:   'hash',
            param:  '$catalog'
        }),
        queue: new SchemaEntry({
    ...
    schedule: Object.freeze({
        file: new SchemaEntry({ // TODO remove this?
            key:    'm2m-schedule:$id:file',
            param:  '$id'
        }),
