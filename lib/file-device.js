...
util.inherits(FileDevice,IoDevice);

FileDevice.prototype._onOpen = function(callback) {
    this.fdin = fs.openSync(this.inFile,'r');
    callback();
};

FileDevice.prototype._onClose = function() {
...
FileDevice.prototype._onWrite = function(buffer,callback){
    var fdout = null;
    try {
